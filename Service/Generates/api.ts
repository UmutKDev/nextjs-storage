...
export interface AuthenticationTokenResponseModel {
    ...
    /**
     * Temporary token used to finalize login with a 2FA code
     */
    'twoFactorToken'?: string;
    /**
     * Lifetime in seconds of the temporary 2FA login token
     */
...
export interface AuthenticationTwoFactorLoginRequestModel {
    /**
     * 6 digit code generated by your authenticator application
     */
    'code': string;
    /**
     * Temporary token received after submitting email & password
     */
    'token': string;
}
...
export const AuthenticationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary Complete login by verifying 2FA challenge code
         * @param {AuthenticationTwoFactorLoginRequestModel} authenticationTwoFactorLoginRequestModel 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        verifyTwoFactorLogin: async (authenticationTwoFactorLoginRequestModel: AuthenticationTwoFactorLoginRequestModel, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'authenticationTwoFactorLoginRequestModel' is not null or undefined
            assertParamExists('verifyTwoFactorLogin', 'authenticationTwoFactorLoginRequestModel', authenticationTwoFactorLoginRequestModel)
            const localVarPath = `/Api/Authentication/TwoFactor/Login`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(authenticationTwoFactorLoginRequestModel, localVarRequestOptions, configuration)
...
export const AuthenticationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async verifyTwoFactorLogin(authenticationTwoFactorLoginRequestModel: AuthenticationTwoFactorLoginRequestModel, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthenticationTokenResponseBaseModel>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.verifyTwoFactorLogin(authenticationTwoFactorLoginRequestModel, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthenticationApi.verifyTwoFactorLogin']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const AuthenticationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Complete login by verifying 2FA challenge code
         * @param {AuthenticationApiVerifyTwoFactorLoginRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        verifyTwoFactorLogin(requestParameters: AuthenticationApiVerifyTwoFactorLoginRequest, options?: RawAxiosRequestConfig): AxiosPromise<AuthenticationTokenResponseBaseModel> {
            return localVarFp.verifyTwoFactorLogin(requestParameters.authenticationTwoFactorLoginRequestModel, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for verifyTwoFactorLogin operation in AuthenticationApi.
 */
export interface AuthenticationApiVerifyTwoFactorLoginRequest {
    readonly authenticationTwoFactorLoginRequestModel: AuthenticationTwoFactorLoginRequestModel
}
...
export class AuthenticationApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public verifyTwoFactorLogin(requestParameters: AuthenticationApiVerifyTwoFactorLoginRequest, options?: RawAxiosRequestConfig) {
        return AuthenticationApiFp(this.configuration).verifyTwoFactorLogin(requestParameters.authenticationTwoFactorLoginRequestModel, options).then((request) => request(this.axios, this.basePath));
    }
}
