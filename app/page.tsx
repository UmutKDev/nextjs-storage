        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              CloudStorage ile dosyalarınızı şifreleyin, yedekleyin ve
              dilediğiniz yerden erişin. Karmaşık arayüzlere veda edin.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {session ? (
                <Link href="/storage">
                  <Button
                    size="lg"
                    className="h-14 px-8 rounded-full text-lg gap-2 shadow-lg shadow-primary/20"
                  >
                ...
                <>
                  ...
                  <Link href="#bento">
                    <Button
                      variant="outline"
                      size="lg"
                      className="h-14 px-8 rounded-full text-lg bg-background/50 backdrop-blur-sm"
                    >
                      Nasıl Çalışır?
                    </Button>
                  </Link>
          ...
          <div className="mt-20 relative mx-auto max-w-5xl aspect-video rounded-2xl border bg-muted/20 backdrop-blur-sm overflow-hidden shadow-2xl">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="text-muted-foreground">
              Modern ihtiyaçlar için tasarlanmış özellikler.
            </p>
          </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground max-w-md">
                    ...
                    videolarınız ve belgeleriniz için asla yer sıkıntısı
                    çekmeyin.
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <div className="mt-8">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    cebinizde. Senkronizasyon anlık gerçekleşir.
                  </p>
                </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Verileriniz sunucularımıza ulaşmadan önce şifrelenir.
                    Anahtar sadece sizde.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border bg-background p-8 relative overflow-hidden group hover:shadow-lg transition-all">
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Optimize edilmiş CDN ağımız sayesinde dosya yükleme ve
                    indirme işlemleri maksimum hızda.
                  </p>
                </div>
              </div>
            </div>
